...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* QWERTY */
    ...
    //                                 KC_SPM2, KC_BSM1, KC_CLGV, KC_GUTA
    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,            KC_SCLN, KC_Y,  KC_U,    KC_L,   KC_J,
    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,            KC_O,    KC_I,  KC_E,    KC_N,   KC_M,
    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,            KC_RLSH, KC_DOT,KC_COMM, KC_H,   KC_K,
                                      KC_SPC, KC_BSM1, KC_CLGV, KC_GUTA
  ),
